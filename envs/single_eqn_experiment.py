...
class singleEqn(Env):
    ...
    def __init__(self, main_eqn='e*(a*x+b)+(c*x+d)', state_rep='integer_1d', normalize_rewards=True, verbose=False, \
         cache=False) -> None:
        super().__init__()
    ...
    def step(self, action_index):
        ...
        # Cataloging
        self.states_seen[f'{self.lhs} = {self.rhs}'] += 1
        ...
        self.actions_taken[(operation_names[operation], term)] += 1
